...
export default function Navigation() {
  ...
  return (
    <nav className="fixed top-0 left-0 w-full z-[9999] px-6 py-3 md:px-12 flex justify-between items-center gap-4 bg-[#6b4a35]/95 backdrop-blur-md border-b border-[#c27a4a]/15" data-testid="navigation">
